...
class Href{
    ...
    function source_code()
    {
        ...
        if($spec_file)
        {
			...
			{
				$ref = new Reflectionobject($this->CI->$spec_file);
        ...
        {
            $code = '<span style="color:#FFF">Does not get source code file!</span>'; 
        }
    ...
    function reflect($params)
    {
        ...
        $medcodes = $this->hot_key_js().'<div 
            style="display:none;font-size:14px;
                    max-height: 500px;
                    overflow:scroll;
                    background-color:black;border:dashed 3px blue;z-index:99999;position:absolute;" 
                        id="'.$this->id.'">
                        <p style="float:right;">
...
AOE;
	...
	{
		return highlight_code(file_get_contents($filepath));
	}
